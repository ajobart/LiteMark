...
const MarkdownEditor: React.FC<MarkdownEditorProps> = ({
     ...
     * @param content - The content to replace emojis in
     * @returns The content with emojis replaced
     */
    ...
    /**
     * Function to render the mobile view
     */
                            ...
                            <ul className='flex w-full gap-1.5'>
                                ...
                                <li>
                                    <button
                                        ...
                                        className="hover:bg-background-border transition ease-in-out duration-250 text-white p-1 rounded"
                                    >
                                ...
                                {!deletedNotes.some(note => note.id === noteId) && (
                                    <li>
                                        ...
                                        >
                                            <Image path={isHovered ? '/icons/trash-red.svg' : '/icons/trash-gray.svg'}
                                                className={`size-5 transition-transform transition-opacity duration-300 ${isHovered ? 'scale-105 opacity-100' : 'scale-100 opacity-100'}`} />
                                        </button>
                                    </li>
                                )}
                                ...
                                {deletedNotes.some(note => note.id === noteId) && (
                                    <li>
                                        <button
                                            ...
                                            className="hover:bg-background-border hover:ring-inset hover:ring-red-400/20 transition ease-in-out duration-250 text-white p-1 rounded"
                                        >
                                            <Image path='/icons/restore.svg' className='size-5'></Image>
                                        </button>
                                    </li>
